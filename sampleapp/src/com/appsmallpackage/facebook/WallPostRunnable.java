...
public class WallPostRunnable implements Runnable {
	...
	while(checkIn)
	{
        ...
        SampleApp.mAsyncRunner.request("me/feed", new NewWallFeedRequestListener()); //get latest wallpost now
...
public void onComplete(final String response, Object state) {
    ...
    try {
       ...
       //now check if it is new or not
         ...
         if( SampleApp.wallfeeds.size()==0                                                ||
        	!SampleApp.wallfeeds.get(0).equals(o.getString("id"))                         ||
        	!SampleApp.wallfeeds.get(1).equals(o.getJSONObject("from").getString("name")) ||
            !SampleApp.wallfeeds.get(2).equals(o.getString("message")))

            {
             ...
             SampleApp.bHandler.sendMessage(msg1);
             ...
             SampleApp.mHandler.sendMessage(msg2);
            
             ///save into wallfeeds
             
             
             SampleApp.wallfeeds.clear();
             SampleApp.wallfeeds.add(o.getString("id"));
             SampleApp.wallfeeds.add(o.getJSONObject("from").getString("name"));
             SampleApp.wallfeeds.add(o.getString("message"));
            }
