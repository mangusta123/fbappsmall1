...
public class FriendProfileActivity extends Activity{
  ...
  final Button   addFriend  = (Button)   findViewById(R.id.add_button);      
        ...
        fbAppSmall.mAsyncRunner.request(getIntent().getStringExtra("id")+"/feed", new NewWallFeedRequestListener());
        ...
        friendList.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				...
				fbAppSmall.mAsyncRunner.request(getIntent().getStringExtra("id")+"/friends", new FriendsRequestListener());
        ...
        addFriend.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				...
				fbAppSmall.mFacebook.dialog(FriendProfileActivity.this, "friends", params, new AddFriendDialogListener());
			...
			public void onClick(View arg0) {
				...
				if(postBox.getText().toString().length()!=0)	
				   ...
				   {			       				
		            ...
		            fbAppSmall.mAsyncRunner.request(getIntent().getStringExtra("id")+"/feed", myParams, "POST", new WallPostRequestListener(), null);
